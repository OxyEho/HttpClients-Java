...
//        System.out.println();
        testHttpClient(httpClient11, 100, "http://localhost:8080/Server_war/json_test", "GET", 1);
        testHttpClient(apacheHttp, 100, "http://localhost:8080/Server_war/json_test", "GET", 1);
